# *Forty Seconds* — Actionable Issues

*Compiled from line-edit-report-2.md and dev-edit-report.md. Confirmed deliberate choices and "no action needed" items are excluded.*
...
## Character and Vivian

- [ ] **Vivian has no particularity** — The observation window elegy asks for grief the story hasn't built. One specific detail from the investigation — something a witness said, something Tom found in the room — would make her a person rather than a function. Does not need to be a scene; one image.

- [ ] **"Everyone he talked to said she'd been worried"** — Setup without payoff. Either cut it, or use Vivian's awareness as part of Tom's deduction (she knew → others close to the subject could see it → nobody around Tom will intervene either).
...
- [ ] **Double metaphor: cornered thing + lit room** — Two metaphors in immediate succession for the same idea. Choose one. The lit room at the end of the corridor is the stronger.

- [ ] **"a long moment" x3** — Appears at the boombox, after the confession, and in the corridor. Vary at least one instance. The boombox moment is the most important — protect that one.

- [ ] **"small seeds of doubt, little splinters of argument"** — "Small" and "little" are redundant given seeds and splinters are already small. Cut both modifiers.

- [ ] **"The shape of the thing"** — The third fragment in the fist-to-chin sequence is abstract where the two before it are concrete nouns. Either make it more concrete or cut it.

- [ ] **"led somewhere ugly" x2** — Repeats across two consecutive sentences. Either confirm as deliberate (grinding fatalism) and add a beat between the two instances, or vary the second.

- [ ] **"shifted slightly"** — "Slightly" weakens the clinical detail in the execution scene. Cut "slightly."

---

## Filter Words and Sentence-Level

- [ ] **"hadn't seemed to notice"** (third-person slip observation) — Hedges what the reader has already directly witnessed. Change to "hadn't noticed."

- [ ] **"What he saw stopped him cold."** — Filter construction creates an expectation (a described object) that the next paragraph delays. Cut or redirect so what Francois sees is described immediately after.

- [ ] **"The question arrived slowly, the way a cold front arrives. Not a dramatic thing. Just a change in the air."** — Three attempts at the same idea. Cut either the simile or the two fragments; both are complete on their own.

- [ ] **Vivian reveal sentence** — "...a stuffed ostrich in a teal collar who went by the name Vivian Plume, and who would never again make anyone's acquaintance." The two "who" clauses trail after the staccato fragments before them. Cut one of the clauses.
...
- [ ] **"in the tone of a man who was already thinking about lunch"** — Minor: cut "who was" to reach the image faster.
